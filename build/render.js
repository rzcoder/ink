...
const render = (node, options) => {
    const inkOptions = Object.assign({ stdout: process.stdout, stdin: process.stdin, stderr: process.stderr, debug: false, clearConsole: true, exitOnCtrlC: true, patchConsole: true }, getOptions(options));
