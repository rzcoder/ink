...
exports.default = (x, y, node, output) => {
    if (typeof node.style.borderStyle === 'string') {
        ...
        const topBorder = (0, colorize_1.default)(box.topLeft + box.horizontal.repeat(width - 2) + box.topRight, color, 'foreground');
        const verticalBorder = ((0, colorize_1.default)(box.vertical, color, 'foreground') + '\n').repeat(height - 2);
        const bottomBorder = (0, colorize_1.default)(box.bottomLeft + box.horizontal.repeat(width - 2) + box.bottomRight, color, 'foreground');
