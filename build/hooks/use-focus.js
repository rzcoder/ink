...
const useFocus = ({ isActive = true, autoFocus = false, id: customId } = {}) => {
    const { isRawModeSupported, setRawMode } = (0, use_stdin_1.default)();
    const { activeId, add, remove, activate, deactivate, focus } = (0, react_1.useContext)(FocusContext_1.default);
