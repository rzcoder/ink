...
class Ink {
    constructor(options) {
        ...
        this.onRender = () => {
            ...
            const { output, outputHeight, staticOutput } = (0, renderer_1.default)(this.rootNode, 
            ...
            if (outputHeight >= this.options.stdout.rows) {
                this.options.stdout.write((this.options.clearConsole ? ansi_escapes_1.default.clearTerminal : "") + this.fullStaticOutput + output);
                this.lastOutput = output;
                return;
            }
        ...
        this.rootNode.onRender = options.debug
            ? this.onRender
            : (0, lodash_1.throttle)(this.onRender, 32, {
                leading: true,
                trailing: true
            });
        ...
        this.throttledLog = options.debug
            ? this.log
            : (0, lodash_1.throttle)(this.log, undefined, {
                leading: true,
                trailing: true
            });
        ...
        this.unsubscribeExit = (0, signal_exit_1.default)(this.unmount, { alwaysLast: false });
    ...
    patchConsole() {
        ...
        this.restoreConsole = (0, patch_console_1.default)((stream, data) => {
            if (stream === 'stdout') {
