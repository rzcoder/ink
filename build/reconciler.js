...
exports.default = (0, react_reconciler_1.default)({
    // @ts-ignore
    ...
    createInstance: (originalType, newProps, _root, hostContext) => {
        ...
        const type = originalType === 'ink-text' && hostContext.isInsideText
            ? 'ink-virtual-text'
            : originalType;
        const node = (0, dom_1.createNode)(type);
        for (const [key, value] of Object.entries(newProps)) {
            if (key === 'children') {
                continue;
            }
            else if (key === 'style') {
                (0, dom_1.setStyle)(node, value);
            }
                ...
                (0, dom_1.setAttribute)(node, key, value);
            }
        }
        return node;
    },
    createTextInstance: (text, _root, hostContext) => {
        ...
        return (0, dom_1.createTextNode)(text);
    },
    resetTextContent: () => { },
    hideTextInstance: node => {
        (0, dom_1.setTextNodeValue)(node, '');
    },
    unhideTextInstance: (node, text) => {
        (0, dom_1.setTextNodeValue)(node, text);
    },
    ...
    removeChildFromContainer: (node, removeNode) => {
        (0, dom_1.removeChildNode)(node, removeNode);
    ...
    commitTextUpdate: (node, _oldText, newText) => {
        (0, dom_1.setTextNodeValue)(node, newText);
    },
